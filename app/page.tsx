...
export default function Home() {
  ...
  async function aiCall(e: FormEvent) {
    e.preventDefault(); //e is event handler/obj. Prevent default prevents page from reloading

    // Use inputValue as a parameter in your aiCall function
    ...
    // Check for null before setting the 'answer' state
